...
function e(t,o,e){
l.num++,o.musicSupport=l.musicSupport,o.show_not_support=!1,l.musicSupport||1!=l.num||(o.show_not_support=!0);
var i=document.createElement("div");
i.innerHTML=c.render(t,o),e.parentNode.appendChild(i.children[0]);
}
function i(){
...
function n(){
for(var t in l.reportData)y.musicreport({
data:l.reportData[t]
});
}
function p(t){
...
var a=t("biz_common/dom/event.js"),c=t("biz_common/tmpl.js"),d=t("pages/loadscript.js"),u=t("pages/music_player.js"),_=t("biz_common/dom/class.js"),y=t("pages/report.js"),l={
...
var t=this._o;
t.src||(0==t.type||1==t.type)&&(t.mid?t.src=l.qqMusiceMid.replace("#mid#",t.mid).replace(/#songId#/g,t.songId||""):t.songId&&(t.src=l.qqMusiceSongId.replace(/#songId#/g,t.songId||"")));
...
"undefined"==typeof l.reportData[t.type]&&(l.reportData[t.type]=y.getMusicReportData(t),
l.posIndex[t.type]=0),this._g.posIndex=l.posIndex[t.type]++;
var o=l.reportData[t.type];
...
l.reportData[o.type].detail_click[e.posIndex]=1,window.location.href=o.detailUrl;
});
...
this.player.play(0),l.reportData[o.type].hasended[e.posIndex]=1,y.report({
type:t,
comment_id:o.comment_id,
voiceid:o.songId,
action:4
...
var t=this,o=this._o,e=this._g;
return function(i,r){
t._updateProgress(this,r),0!=r&&(l.reportData[o.type].play_duration[e.posIndex]=parseInt(1e3*r));
};
},o.prototype._errorCallBack=function(){
var t=this,o=this._o,e=this._g;
return function(i,r){
l.reportData[o.type].errorcode[e.posIndex]=r,t._updatePlayerCss(this,3);
};
...
R.list.appendChild(m),t(R.main),t(document.getElementById("js_cmt_addbtn1")),e.elected_comment_total_cnt<=10&&(t(document.getElementById("js_cmt_statement")),
t(document.getElementById("js_cmt_qa")))):(n(R.main),1==copyright_stat&&1==need_pay&&I.addClass(document.body,"rich_media_empty_extra"),
...
0==e.elected_comment_total_cnt?(T=-1,E.off(window,"scroll",i),n(document.getElementById("js_cmt_loading")),
n(document.getElementById("js_cmt_statement")),n(document.getElementById("js_cmt_qa"))):T+z>=e.elected_comment_total_cnt?(T=-1,
E.off(window,"scroll",i),n(document.getElementById("js_cmt_loading")),t(document.getElementById("js_cmt_statement")),
t(document.getElementById("js_cmt_qa"))):T+=e.elected_comment.length;
}
function a(){
x.log("tag1");
var e=m(R.input.value);
if(x.log("tag2"),!I.hasClass(R.submit,"btn_disabled")){
if(x.log("tag3"),e.length<1)return u("评论不能为空");
if(x.log("tag4"),e.length>600)return u("字数不能多于600个");
x.log("tag5"),I.addClass(R.submit,"btn_disabled"),x.log("tag6");
...
complete:function(){
""!=R.input.value&&I.removeClass(R.submit,"btn_disabled");
}
});
}
}
...
c&&c.length&&(l(c,a,"mine"),R.mylist.appendChild(a),t(R.mylist.parentNode)),H=2;
...
m+=C.render("t_cmt",a);
try{
var l=a.nick_name+a.content,u=!1,p=23;
L[l]&&(u=!0,p=24),U.indexOf(a.content_id)>-1&&(u=!0,p=23),U.push(a.content_id),L[l]=!0,
u&&(S.src="http://mp.weixin.qq.com/mp/jsreport?key="+p+"&content="+encodeURIComponent(JSON.stringify({
comment_id:comment_id,
...
e.innerHTML=B.encode(e.innerHTML);
});
}
function u(e){
...
function _(e){
n(R.article),t(R.mine),window.scrollTo(0,0),s(),e||x.later(function(){
R.input.focus();
});
}
function g(){
...
if(I.hasClass(t,"js_comment_praise")&&(n=t),I.hasClass(t,"icon_praise_gray")&&"i"==t.nodeName.toLowerCase()&&(n=t.parentElement),
I.hasClass(t,"praise_num")&&"span"==t.nodeName.toLowerCase()&&(n=t.parentElement),
n){
...
function f(e){
var t=I.hasClass(e,"praised"),n=e.querySelector(".praise_num"),o=n.innerHTML,m=o.indexOf("万"),i=parseInt(o)?parseInt(o):0;
t?(-1==m&&(n.innerHTML=i-1>0?i-1:""),I.removeClass(e,"praised"),e.dataset.status=0):(-1==m&&(n.innerHTML=i+1),
I.addClass(e,"praised"),e.dataset.status=1);
}
function h(e){
...
var E=e("biz_common/dom/event.js"),I=e("biz_common/dom/class.js"),v=e("biz_wap/utils/ajax.js"),C=(e("biz_common/utils/string/html.js"),
e("biz_common/tmpl.js")),k=e("biz_wap/utils/hashrouter.js"),B=e("appmsg/emotion/emotion.js"),x=e("appmsg/emotion/dom.js"),q=new Image,T=0,z=50,M=!1,D=null,N="",O="我",H=0,R={
...
"comment"==e&&g();
}),E.on(R.input,"input",function(){
var e=m(R.input.value);
e.length<1?I.addClass(R.submit,"btn_disabled"):I.removeClass(R.submit,"btn_disabled");
}),E.on(R.more,"touchend",y),E.on(R.list,"touchend",y),E.on(R.mylist,"touchend",y),
E.on(R.list,"tap",".js_del",h),E.on(R.mylist,"tap",".js_del",h),E.on(R.submit,"touchend",a);
}
