...
});define("a/gotoappdetail.js",["biz_common/dom/event.js","biz_common/utils/report.js","biz_wap/utils/ajax.js","biz_wap/utils/position.js","biz_common/dom/class.js","appmsg/a_report.js","biz_wap/jsapi/core.js"],function(t){
"use strict";
function a(t){
...
if(!n)return!1;
var l={},u=t.adData,g="",v="",j=u.md5sum,w="",b=t.pos_type||0;
if(function(){
...
var k=u.androiddownurl;
if(v=g=u.channel_id||"",k&&k.match){
var h=/&channelid\=([^&]*)/,y=k.match(h);
y&&y[1]&&(g=y[1],u.androiddownurl=k.replace(h,""));
}
g&&(g="&channelid="+g),t.via&&(w=["&via=ANDROIDWX.YYB.WX.ADVERTISE",t.via].join("."));
}
c.ready(function(){
"104"==u.pt&&(c.invoke("getInstallState",{
packageName:m
},function(t){
var e=t.err_msg;
a("getInstallState @yingyongbao : "+e);
var n=e.lastIndexOf("_")+1,i=e.substring(n);
1*i>=f&&e.indexOf("get_install_state:yes")>-1&&(_=!0);
...
})),i.on(n,"click",function(n){
if(a("click @js_app_action"),p&&"104"==u.pt)return!1;
var i=function(){
if("104"==u.pt)return _?(e(24,t),void(location.href="tmast://download?oplist=1;2&pname="+u.pkgname+g+w)):(e(25,t),
void(location.href="http://mp.weixin.qq.com/mp/ad_app_info?t=ad/app_detail&app_id="+u.app_id+(t.appdetail_params||"")+"&channel_id="+v+"&md5sum="+j+"&auto=1#wechat_redirect"));
if("103"==u.pt){
e(23,t);
...
if(!l[u.traceid]){
l[u.traceid]=!0;
var o,s,m=!!n&&n.target;
m&&(o=r.getX(m,"js_ad_link extra_link")+n.offsetX,s=r.getY(m,"js_ad_link extra_link")+n.offsetY),
d({
type:u.type,
report_type:2,
click_pos:0,
url:encodeURIComponent(u.androiddownurl),
tid:u.traceid,
rl:encodeURIComponent(u.rl),
__biz:biz,
pos_type:b,
pt:u.pt,
pos_x:o,
